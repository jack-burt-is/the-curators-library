...
@onready var subtotal_value: Label = $PanelContainer/MarginContainer/VBoxContainer/Body/CartContainer/VBoxContainer/MarginContainer/Cart/Actions/SubtotalValue
...
func _on_cart_items_child_exiting_tree(_node: Node) -> void:
	refresh_subtotal()

func refresh_subtotal():
	var total_value = 0
